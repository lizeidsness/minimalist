  ...
  render() {
    ...
    return (h(Host, { dir: dir },
      h("div", { class: "split-button__container" },
        ...
        h("calcite-dropdown", { dir: dir, onClick: this.calciteSplitButtonSecondaryClickHandler, placement: "bottom-trailing", scale: this.scale, theme: this.theme, width: this.scale },

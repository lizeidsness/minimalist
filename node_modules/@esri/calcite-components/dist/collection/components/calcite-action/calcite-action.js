...
export class CalciteAction {
  ...
  render() {
    ...
    return (h(Host, null,
      h("button", { "aria-busy": loading.toString(), "aria-disabled": disabled.toString(), "aria-label": ariaLabel, class: buttonClasses, disabled: disabled, onClick: this.buttonClick, ref: (buttonEl) => (this.buttonEl = buttonEl) },

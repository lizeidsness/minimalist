...
:host([icon-start][dir=rtl]:not([icon-end])) .content {
  margin-left: unset;
  margin-right: 0.5rem;
}

:host([icon-end][dir=rtl]:not([icon-start])) .content {
  margin-right: unset;
  margin-left: 0.5rem;
}
...
:host([dir=rtl][alignment=icon-start-space-between]:not([width=auto])) .icon--start {
  margin-right: unset;
  margin-left: auto;
}

:host([dir=rtl][alignment=icon-end-space-between]:not([width=auto])) .icon--end {
  margin-left: unset;
  margin-right: auto;
}
...
:host([dir=rtl][alignment=center]) a:not(.content--slotted) .icon--start + .icon--end,
:host([dir=rtl][alignment=center]) button:not(.content--slotted) .icon--start + .icon--end {
  margin-left: unset;
  margin-right: 0.5rem;
}
...
:host([loading]) button .calcite-button--icon,
:host([loading]) a .calcite-button--icon {
  opacity: 0;
}

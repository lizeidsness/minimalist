...
export class CalciteDatePickerDay {
  ...
  render() {
    ...
    return (h(Host, { dir: dir, onClick: this.onClick, onKeyDown: this.keyDownHandler, role: "gridcell", tabindex: this.active ? 0 : -1 },
  ...
  static get originalStyleUrls() { return {
    "$": ["calcite-date-picker-day.scss"]
  }; }
  static get styleUrls() { return {
    "$": ["calcite-date-picker-day.css"]
  }; }

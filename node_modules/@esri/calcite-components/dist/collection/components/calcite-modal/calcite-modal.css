...
:host([scale=s]) {
  --calcite-modal-padding: 0.5rem;
  --calcite-modal-padding-large: 0.75rem;
...
:host([is-active][fullscreen]) .modal {
  transform: translate3D(0, 0, 0) scale(1);
}

:host([is-active][fullscreen]) .header {
  border-radius: 0;
}

:host([is-active][fullscreen]) .footer {
  border-radius: 0;
}

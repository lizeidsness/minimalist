  ...
  renderLeftEllipsis(iconScale) {
    if (this.total / this.num > maxPagesDisplayed && this.showLeftEllipsis()) {
      return (h("span", { class: `${CSS.ellipsis} ${CSS.ellipsisStart}` },
        h("calcite-icon", { icon: "ellipsis", scale: iconScale })));
    }
  }
  ...
  render() {
    ...
    return (h(Host, { dir: dir },
      h("button", { "aria-label": this.textLabelPrevious, class: {
        ...
        h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronLeft", scale: iconScale })),
      ...
      h("button", { "aria-label": this.textLabelNext, class: {
        ...
        h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronRight", scale: iconScale }))));
  }

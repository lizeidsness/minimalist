...
:host([scale=s]) slot[name=notice-title]::slotted(*),
:host([scale=s]) *::slotted([slot=notice-title]) {
  font-size: var(--calcite-font-size--1);
  line-height: 1.375;
  margin-bottom: 0.25rem;
}

:host([scale=s]) slot[name=notice-message]::slotted(*),
:host([scale=s]) *::slotted([slot=notice-message]) {
...
:host([scale=m]) slot[name=notice-title]::slotted(*),
:host([scale=m]) *::slotted([slot=notice-title]) {
  font-size: var(--calcite-font-size-0);
  line-height: 1.375;
  margin-bottom: 0.25rem;
}

:host([scale=m]) slot[name=notice-message]::slotted(*),
:host([scale=m]) *::slotted([slot=notice-message]) {
  font-size: var(--calcite-font-size--1);
  line-height: 1.375;
  margin-bottom: 0.25rem;
}
...
:host([scale=l]) {
  --calcite-notice-spacing-token-small: 1.25rem;
  --calcite-notice-spacing-token-large: 1.5rem;
}

:host([scale=l]) slot[name=notice-title]::slotted(*),
:host([scale=l]) *::slotted([slot=notice-title]) {
  font-size: var(--calcite-font-size-1);
  line-height: 1.375;
  margin-bottom: 0.25rem;
}

:host([scale=l]) slot[name=notice-message]::slotted(*),
:host([scale=l]) *::slotted([slot=notice-message]) {
  font-size: var(--calcite-font-size-0);
  line-height: 1.375;
  margin-bottom: 0.25rem;
}
...
slot[name=notice-title]::slotted(*),
*::slotted([slot=notice-title]) {
  margin: 0;
  font-weight: var(--calcite-font-weight-medium);
  color: var(--calcite-ui-text-1);
}

slot[name=notice-message]::slotted(*),
*::slotted([slot=notice-message]) {
  display: inline;
  margin: 0;
...
:host([dir=rtl]) slot[name=notice-message]::slotted(*),
:host([dir=rtl]) *::slotted([slot=notice-message]) {
  margin-right: 0;
...
:host([dir=rtl]) .notice-content:only-of-type {
  padding: var(--calcite-notice-spacing-token-small) var(--calcite-notice-spacing-token-large);
}

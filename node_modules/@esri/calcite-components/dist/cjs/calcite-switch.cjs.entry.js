...
const CalciteSwitch = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { tabindex: this.tabindex }, index.h("div", { "aria-checked": this.switched.toString(), class: { container: true, [resources.CSS_UTILITY.rtl]: dir === "rtl" } }, index.h("div", { class: "track" }, index.h("div", { class: "handle" })))));
  }

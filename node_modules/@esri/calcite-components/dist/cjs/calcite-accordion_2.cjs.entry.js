...
const CalciteAccordionItem = class {
  ...
  connectedCallback() {
    ...
    this.iconPosition = dom.getElementProp(this.el, "icon-position", "end");
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-expanded": this.active.toString(), dir: dir, "icon-position": this.iconPosition, tabindex: "0" }, index.h("div", { class: "accordion-item-header", onClick: this.itemHeaderClickHandler }, this.icon ? iconEl : null, index.h("div", { class: "accordion-item-header-text" }, index.h("span", { class: "accordion-item-title" }, this.itemTitle), this.itemSubtitle ? (index.h("span", { class: "accordion-item-subtitle" }, this.itemSubtitle)) : null), index.h("calcite-icon", { class: "accordion-item-expand-icon", icon: this.iconType === "chevron"
        ? "chevronUp"
        : this.iconType === "caret"
          ? "caretUp"
          : this.active

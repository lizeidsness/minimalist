...
const CalciteCombobox = class {
  ...
  renderChips() {
    ...
    return this.selectedItems.map((item, i) => {
      ...
      return (index.h("calcite-chip", { class: chipClasses, dismissLabel: "remove tag", dismissible: true, icon: item.icon, id: `chip-${item.guid}`, key: item.value, onCalciteChipDismiss: (event) => this.calciteChipDismissHandler(event, item), scale: scale, value: item.value }, label));
    });
  }
  renderInput() {

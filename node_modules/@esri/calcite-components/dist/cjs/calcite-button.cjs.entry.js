...
const CalciteButton = class {
  ...
  render() {
    ...
    const loader = (index.h("div", { class: CSS.buttonLoader }, index.h("calcite-loader", { active: true, inline: true, label: this.intlLoading })));
    const iconScale = this.scale === "l" ? "m" : "s";
    const iconStartEl = (index.h("calcite-icon", { class: { [CSS.icon]: true, [CSS.iconStart]: true }, dir: dir, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: iconScale }));
    const iconEndEl = (index.h("calcite-icon", { class: { [CSS.icon]: true, [CSS.iconEnd]: true }, dir: dir, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: iconScale }));
    ...
    return (index.h(index.Host, { dir: dir }, index.h(Tag, Object.assign({}, attributes, className, { disabled: this.disabled, onClick: this.handleClick, ref: (el) => (this.childEl = el), tabIndex: this.disabled ? -1 : null }), this.loading ? loader : null, this.iconStart ? iconStartEl : null, this.hasContent ? contentEl : null, this.iconEnd ? iconEndEl : null)));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods

...
const CalcitePagination = class {
  ...
  renderLeftEllipsis(iconScale) {
    if (this.total / this.num > maxPagesDisplayed && this.showLeftEllipsis()) {
      return (index.h("span", { class: `${CSS.ellipsis} ${CSS.ellipsisStart}` }, index.h("calcite-icon", { icon: "ellipsis", scale: iconScale })));
    }
  }
  renderRightEllipsis(iconScale) {
    if (this.total / this.num > maxPagesDisplayed && this.showRightEllipsis()) {
      return (index.h("span", { class: `${CSS.ellipsis} ${CSS.ellipsisEnd}` }, index.h("calcite-icon", { icon: "ellipsis", scale: iconScale })));
    }
  }
  render() {
    ...
    return (index.h(index.Host, { dir: dir }, index.h("button", { "aria-label": this.textLabelPrevious, class: {
        [CSS.previous]: true,
        [CSS.disabled]: prevDisabled
      }, disabled: prevDisabled, onClick: this.previousClicked }, index.h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronLeft", scale: iconScale })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(iconScale), this.renderPages(), this.renderRightEllipsis(iconScale), this.renderPage(this.getLastStart()), index.h("button", { "aria-label": this.textLabelNext, class: {
        [CSS.next]: true,
        [CSS.disabled]: nextDisabled
      }, disabled: nextDisabled, onClick: this.nextClicked }, index.h("calcite-icon", { dir: dir, flipRtl: true, icon: "chevronRight", scale: iconScale }))));
  }

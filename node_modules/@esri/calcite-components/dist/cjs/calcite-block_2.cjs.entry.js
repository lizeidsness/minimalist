...
const CalciteBlock = class {
  ...
  renderScrim() {
    ...
    return [
      loading || disabled ? index.h("calcite-scrim", { loading: loading, theme: theme }) : null,
      defaultSlot
    ];
  }
  render() {
    ...
    const headerContent = (index.h("header", { class: CSS$1.header }, hasIcon ? (index.h("div", { class: CSS$1.icon }, index.h("slot", { name: SLOTS.icon }))) : null, index.h("div", { class: CSS$1.title }, index.h(CalciteHeading.CalciteHeading, { class: CSS$1.heading, level: headingLevel }, heading), summary ? index.h("div", { class: CSS$1.summary }, summary) : null)));
    const hasControl = dom.getSlotted(el, SLOTS.control);
    const headerNode = (index.h("div", { class: CSS$1.headerContainer }, this.dragHandle ? index.h("calcite-handle", null) : null, collapsible ? (index.h("button", { "aria-label": toggleLabel, class: CSS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent)) : (headerContent), loading ? (index.h("calcite-loader", { inline: true, "is-active": true, label: intlLoading })) : hasControl ? (index.h("div", { class: CSS$1.controlContainer }, index.h("slot", { name: SLOTS.control }))) : null));

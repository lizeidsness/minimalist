...
const CalciteShell = class {
  ...
  // --------------------------------------------------------------------------
  renderHeader() {
    const hasHeader = !!dom.getSlotted(this.el, SLOTS$1.header);
    return hasHeader ? index.h("slot", { name: SLOTS$1.header }) : null;
  }
  renderContent() {
    const content = !!this.contentBehind
      ? [
        index.h("div", { class: {
            [CSS$1.content]: true,
            [CSS$1.contentBehind]: !!this.contentBehind
          } }, index.h("slot", null)),
        index.h("slot", { name: "center-row" })
      ]
      : [
        index.h("div", { class: CSS$1.content }, index.h("slot", null), index.h("slot", { name: "center-row" }))
      ];
    return content;
  }
  renderFooter() {
    const hasFooter = !!dom.getSlotted(this.el, SLOTS$1.footer);
    return hasFooter ? (index.h("div", { class: CSS$1.footer }, index.h("slot", { name: SLOTS$1.footer }))) : null;
  }
  renderMain() {
    const primaryPanel = dom.getSlotted(this.el, SLOTS$1.primaryPanel);
    const mainClasses = {
      [CSS$1.main]: true,
      [CSS$1.mainReversed]: (primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.position) === "end"
    };
    return (index.h("div", { class: mainClasses }, index.h("slot", { name: SLOTS$1.primaryPanel }), this.renderContent(), index.h("slot", { name: SLOTS$1.contextualPanel })));
  }
  render() {
...
const CalciteShellPanel = class {
  ...
  render() {
    ...
    const contentNode = (index.h("div", { class: { [CSS.content]: true, [CSS.contentDetached]: detached }, hidden: collapsed }, this.renderHeader(), index.h("div", { class: CSS.contentBody }, index.h("slot", null))));

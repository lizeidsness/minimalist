...
const CalcitePanel = class {
  ...
  renderMenu() {
    ...
    return hasMenuItems ? (index.h("calcite-action-menu", { flipPlacements: ["top", "bottom"], label: intlOptions || TEXT.options, open: menuOpen, placement: "bottom-end" }, index.h("slot", { name: SLOTS.headerMenuActions }))) : null;
  }
  renderHeaderNode() {
  ...
  render() {
    ...
    return (index.h(index.Host, null, loading || disabled ? index.h("calcite-scrim", { loading: loading }) : null, panelNode));
  }
  get el() { return index.getElement(this); }

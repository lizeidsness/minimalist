...
const CalcitePopover = class {
  ...
  renderCloseButton() {
    ...
    return closeButton ? (index.h("button", { "aria-label": intlClose, class: { [CSS.closeButton]: true }, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), title: intlClose }, index.h("calcite-icon", { icon: "x", scale: "m" }))) : null;
  }
  render() {
    ...
    return (index.h(index.Host, { "aria-hidden": hidden.toString(), "aria-label": label, "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, index.h("div", { class: {
      ...
      } }, arrowNode, index.h("div", { class: CSS.container }, index.h("div", { class: CSS.content }, index.h("slot", null)), this.renderCloseButton()))));
  }
...
const CalcitePopoverManager = class {
  constructor(hostRef) {
    ...
    this.getRelatedPopover = (el) => {
      return dom.getElementByAttributeId(el.closest(this.selector), POPOVER_REFERENCE);
    };
  }
  // --------------------------------------------------------------------------
  //

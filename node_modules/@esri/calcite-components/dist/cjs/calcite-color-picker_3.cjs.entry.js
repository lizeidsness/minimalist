...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.handleColorFieldScopeKeyDown = (event) => {
      ...
      if (Object.keys(arrowKeyToXYOffset).includes(key$1)) {
        event.preventDefault();
        this.captureColor(this.colorFieldScopeLeft + arrowKeyToXYOffset[key$1].x || 0, this.colorFieldScopeTop + arrowKeyToXYOffset[key$1].y || 0);
    ...
    this.handleHueScopeKeyDown = (event) => {
      ...
      if (Object.keys(arrowKeyToXOffset).includes(key$1)) {
        event.preventDefault();
        const delta = arrowKeyToXOffset[key$1] * modifier;
        const hue = (_a = this.baseColorFieldColor) === null || _a === void 0 ? void 0 : _a.hue();
        const color$1 = hue ? this.baseColorFieldColor.hue(hue + delta) : color({ h: 0, s: 0, v: 100 });
        this.internalColorSet(color$1, false);
        return;
      }
    };
    ...
    this.renderChannelsTabTitle = (channelMode) => {
      ...
      return (index.h("calcite-tab-title", { active: active, class: CSS$2.colorMode, "data-color-mode": channelMode, onCalciteTabsActivate: this.handleTabActivate }, label));
    };
    this.renderChannelsTab = (channelMode) => {
      ...
      return (index.h("calcite-tab", { active: active, class: CSS$2.control }, index.h("div", { class: CSS$2.channels }, channels.map((channel, index) => this.renderChannel(channel, index, channelLabels[index], channelAriaLabels[index])))));
    };
    this.renderChannel = (value, index$1, label, ariaLabel) => (index.h("calcite-input", { "aria-label": ariaLabel, class: CSS$2.channel, "data-channel-index": index$1, numberButtonType: "none", onChange: this.handleChannelChange, onInput: this.handleChannelInput, onKeyDown: this.handleChannelKeyUpOrDown, onKeyUp: this.handleChannelKeyUpOrDown, prefixText: label, scale: "s", type: "number", value: value !== null ? value.toString() : "" }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS$2.container }, index.h("div", { class: CSS$2.colorFieldAndSliderWrap }, index.h("canvas", { class: {
      ...
      }, onMouseEnter: this.handleColorFieldAndSliderMouseEnterOrMove, onMouseLeave: this.handleColorFieldAndSliderMouseLeave, onMouseMove: this.handleColorFieldAndSliderMouseEnterOrMove, ref: this.initColorFieldAndSlider }), index.h("div", { "aria-label": vertical ? this.intlValue : this.intlSaturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color === null || color === void 0 ? void 0 : color.saturationv() : color === null || color === void 0 ? void 0 : color.value()) || "0", class: CSS$2.scope, onKeyDown: this.handleColorFieldScopeKeyDown, role: "slider", style: { top: `${colorFieldScopeTop || 0}px`, left: `${colorFieldScopeLeft || 0}px` }, tabindex: "0" }), index.h("div", { "aria-label": this.intlHue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": (color === null || color === void 0 ? void 0 : color.round().hue()) || DEFAULT_COLOR$1.round().hue(), class: CSS$2.scope, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: { top: `${hueTop}px`, left: `${hueLeft}px` }, tabindex: "0" })), hideHex && hideChannels ? null : (index.h("div", { class: { [CSS$2.controlSection]: true, [CSS$2.section]: true } }, hideHex ? null : (index.h("div", { class: CSS$2.hexOptions }, index.h("span", { class: {
        [CSS$2.header]: true,
        [CSS$2.headerHex]: true,
        [CSS$2.underlinedHeader]: true
      } }, intlHex), index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS$2.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [CSS$2.colorModeContainer]: true,
        [CSS$2.splitSection]: true
      }, dir: elementDir }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, index.h("div", { class: CSS$2.header }, index.h("label", null, intlSaved), index.h("div", { class: CSS$2.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS$2.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), index.h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS$2.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (index.h("div", { class: CSS$2.savedColors }, [
      ...savedColors.map((color) => (index.h("calcite-color-picker-swatch", { active: selectedColorInHex === color, class: CSS$2.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })))
    ])) : null))));
  }
  // --------------------------------------------------------------------------
  //
...
const calciteColorPickerHexInputCss = "@-webkit-keyframes in{0%{opacity:0}100%{opacity:1}}@keyframes in{0%{opacity:0}100%{opacity:1}}@-webkit-keyframes in-down{0%{opacity:0;-webkit-transform:translate3D(0, -5px, 0);transform:translate3D(0, -5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@keyframes in-down{0%{opacity:0;-webkit-transform:translate3D(0, -5px, 0);transform:translate3D(0, -5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@-webkit-keyframes in-up{0%{opacity:0;-webkit-transform:translate3D(0, 5px, 0);transform:translate3D(0, 5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@keyframes in-up{0%{opacity:0;-webkit-transform:translate3D(0, 5px, 0);transform:translate3D(0, 5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@-webkit-keyframes in-scale{0%{opacity:0;-webkit-transform:scale3D(0.95, 0.95, 1);transform:scale3D(0.95, 0.95, 1)}100%{opacity:1;-webkit-transform:scale3D(1, 1, 1);transform:scale3D(1, 1, 1)}}@keyframes in-scale{0%{opacity:0;-webkit-transform:scale3D(0.95, 0.95, 1);transform:scale3D(0.95, 0.95, 1)}100%{opacity:1;-webkit-transform:scale3D(1, 1, 1);transform:scale3D(1, 1, 1)}}:root{--calcite-popper-transition:150ms ease-in-out}:host([hidden]){display:none}:host{display:block}.container{width:100%;display:inline-grid;-ms-flex-align:center;align-items:center;grid-template-columns:1fr auto}.preview{grid-column:2/3;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;pointer-events:none;margin-top:0;margin-bottom:0;margin-left:0.25rem;margin-right:0.25rem;z-index:1}.preview,.input{grid-row:1}.input{grid-column:1/3;text-transform:uppercase;width:100%}";
...
const CalciteColorPickerHexInput = class {
  ...
  render() {
    ...
    const elementDir = dom.getElementDir(el);
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: this.storeInputRef, scale: "s", value: hexInputValue }), hexInputValue ? (index.h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const CalciteColorPickerSwatch = class {
  ...
  render() {
    ...
    const theme = dom.getElementProp(el, "theme", "light", true);
    const borderColor = theme === "light" ? COLORS.borderLight : COLORS.borderDark;
    return (index.h(index.Host, { "aria-label": hex, title: hex }, index.h("svg", { class: CSS.swatch, xmlns: "http://www.w3.org/2000/svg" }, index.h("rect", { fill: hex, height: "100%", id: "swatch", rx: borderRadius, stroke: borderColor, "stroke-width": "2", style: { "clip-path": `inset(0 round ${borderRadius})` }, width: "100%" }))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "color": ["handleColorChange"]

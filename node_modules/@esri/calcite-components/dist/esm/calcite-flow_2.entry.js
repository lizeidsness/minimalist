...
import { g as getElementDir, c as getSlotted } from './dom-8588618b.js';
...
const CalcitePanel = class {
  ...
  renderMenu() {
    ...
    return hasMenuItems ? (h("calcite-action-menu", { flipPlacements: ["top", "bottom"], label: intlOptions || TEXT.options, open: menuOpen, placement: "bottom-end" }, h("slot", { name: SLOTS.headerMenuActions }))) : null;
  }
  renderHeaderNode() {
  ...
  render() {
    ...
    return (h(Host, null, loading || disabled ? h("calcite-scrim", { loading: loading }) : null, panelNode));
  }
  get el() { return getElement(this); }
...
export { CalciteFlow as calcite_flow, CalcitePanel as calcite_panel };

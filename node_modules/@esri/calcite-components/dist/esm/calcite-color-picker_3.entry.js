import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-eb209d91.js';
import { f as focusElement, g as getElementDir, b as getElementProp } from './dom-8588618b.js';
...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.handleColorFieldScopeKeyDown = (event) => {
      ...
      if (Object.keys(arrowKeyToXYOffset).includes(key)) {
        ...
        this.captureColor(this.colorFieldScopeLeft + arrowKeyToXYOffset[key].x || 0, this.colorFieldScopeTop + arrowKeyToXYOffset[key].y || 0);
    ...
    this.renderChannel = (value, index, label, ariaLabel) => (h("calcite-input", { "aria-label": ariaLabel, class: CSS$2.channel, "data-channel-index": index, numberButtonType: "none", onChange: this.handleChannelChange, onInput: this.handleChannelInput, onKeyDown: this.handleChannelKeyUpOrDown, onKeyUp: this.handleChannelKeyUpOrDown, prefixText: label, scale: "s", type: "number", value: value !== null ? value.toString() : "" }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.colorFieldAndSliderWrap }, h("canvas", { class: {
      ...
      }, onMouseEnter: this.handleColorFieldAndSliderMouseEnterOrMove, onMouseLeave: this.handleColorFieldAndSliderMouseLeave, onMouseMove: this.handleColorFieldAndSliderMouseEnterOrMove, ref: this.initColorFieldAndSlider }), h("div", { "aria-label": vertical ? this.intlValue : this.intlSaturation, "aria-valuemax": vertical ? HSV_LIMITS.v : HSV_LIMITS.s, "aria-valuemin": "0", "aria-valuenow": (vertical ? color === null || color === void 0 ? void 0 : color.saturationv() : color === null || color === void 0 ? void 0 : color.value()) || "0", class: CSS$2.scope, onKeyDown: this.handleColorFieldScopeKeyDown, role: "slider", style: { top: `${colorFieldScopeTop || 0}px`, left: `${colorFieldScopeLeft || 0}px` }, tabindex: "0" }), h("div", { "aria-label": this.intlHue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": (color === null || color === void 0 ? void 0 : color.round().hue()) || DEFAULT_COLOR$1.round().hue(), class: CSS$2.scope, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: { top: `${hueTop}px`, left: `${hueLeft}px` }, tabindex: "0" })), hideHex && hideChannels ? null : (h("div", { class: { [CSS$2.controlSection]: true, [CSS$2.section]: true } }, hideHex ? null : (h("div", { class: CSS$2.hexOptions }, h("span", { class: {
        [CSS$2.header]: true,
        [CSS$2.headerHex]: true,
        [CSS$2.underlinedHeader]: true
      } }, intlHex), h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS$2.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (h("calcite-tabs", { class: {
        [CSS$2.colorModeContainer]: true,
        [CSS$2.splitSection]: true
      }, dir: elementDir }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, h("div", { class: CSS$2.header }, h("label", null, intlSaved), h("div", { class: CSS$2.savedColorsButtons }, h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS$2.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS$2.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (h("div", { class: CSS$2.savedColors }, [
      ...savedColors.map((color) => (h("calcite-color-picker-swatch", { active: selectedColorInHex === color, class: CSS$2.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })))
    ])) : null))));
  }
  // --------------------------------------------------------------------------
  //
...
const CalciteColorPickerHexInput = class {
  ...
  render() {
    ...
    const elementDir = getElementDir(el);
    return (h("div", { class: CSS$1.container }, h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: this.storeInputRef, scale: "s", value: hexInputValue }), hexInputValue ? (h("calcite-color-picker-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const CalciteColorPickerSwatch = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-label": hex, title: hex }, h("svg", { class: CSS.swatch, xmlns: "http://www.w3.org/2000/svg" }, h("rect", { fill: hex, height: "100%", id: "swatch", rx: borderRadius, stroke: borderColor, "stroke-width": "2", style: { "clip-path": `inset(0 round ${borderRadius})` }, width: "100%" }))));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "color": ["handleColorChange"]

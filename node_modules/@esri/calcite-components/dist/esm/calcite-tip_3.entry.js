...
import { C as CalciteHeading, a as ConstrainHeadingLevel } from './CalciteHeading-1a98987c.js';
...
const CalciteTip = class {
  ...
  render() {
    return (h(Host, null, h("article", { class: CSS.container }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
  }
...
const CalciteTipManager = class {
  constructor(hostRef) {
     ...
     * Number at which section headings should start for this component.
     */
    this.headingLevel = HEADING_LEVEL$1;
  ...
  render() {
    ...
    return (h(Host, null, h("section", { "aria-hidden": closed.toString(), class: CSS$1.container, hidden: closed, onKeyUp: this.tipManagerKeyUpHandler, ref: this.storeContainerRef, tabIndex: 0 }, h("header", { class: CSS$1.header }, h(CalciteHeading, { class: CSS$1.heading, level: headingLevel }, groupTitle), h("calcite-action", { class: CSS$1.close, icon: ICONS$1.close, onClick: this.hideTipManager, text: closeLabel })), h("div", { class: {

...
import { n as nodeListToArray, g as getElementDir, b as getElementProp } from './dom-8588618b.js';
import { g as getKey } from './key-477fdfc4.js';
import { u as updatePopper, c as createPopper, C as CSS$2 } from './popper-766cf217.js';
...
const CalciteCombobox = class {
  ...
  renderChips() {
    ...
    return this.selectedItems.map((item, i) => {
      ...
      return (h("calcite-chip", { class: chipClasses, dismissLabel: "remove tag", dismissible: true, icon: item.icon, id: `chip-${item.guid}`, key: item.value, onCalciteChipDismiss: (event) => this.calciteChipDismissHandler(event, item), scale: scale, value: item.value }, label));
    });
  }
  renderInput() {
...
const CalciteComboboxItem = class {
  ...
  renderIcon(scale, isSingle) {
    ...
    const level = `${CSS$1.icon}--indent-${getDepth(el)}`;
    ...
    return showDot ? (h("span", { class: {
        ...
        [CSS$1.icon]: !icon,
        [CSS$1.custom]: !!icon,
        [CSS$1.iconActive]: icon && isSelected,
        [level]: true
  ...
  render() {
    ...
    const classes = {
      [CSS$1.label]: true,
      [CSS$1.selected]: this.isSelected,
      [CSS$1.active]: this.active,
      [CSS$1.single]: isSingleSelect
    };
    const scale = getElementProp(this.el, "scale", "m");
    const dir = getElementDir(this.el);
    return (h(Host, { "aria-hidden": true, dir: dir, disabled: this.disabled, scale: scale, tabIndex: -1 }, h("li", { class: classes, id: this.guid, onClick: this.itemClickHandler, ref: (el) => (this.comboboxItemEl = el), tabIndex: -1 }, this.renderIcon(scale, isSingleSelect), h("span", { class: CSS$1.title }, this.textLabel)), this.renderChildren()));
  }
  get el() { return getElement(this); }
  static get watchers() { return {

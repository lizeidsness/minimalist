...
const CalciteFab = class {
  ...
  render() {
    ...
    return (h(Host, null, h("calcite-button", { appearance: appearance, "aria-label": label, class: CSS.button, color: color, dir: dir, disabled: disabled, iconStart: icon, loading: loading, ref: (buttonEl) => {

import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-eb209d91.js';
import { c as getSlotted } from './dom-8588618b.js';
...
const CalciteShell = class {
  ...
  // --------------------------------------------------------------------------
  renderHeader() {
    const hasHeader = !!getSlotted(this.el, SLOTS$1.header);
    return hasHeader ? h("slot", { name: SLOTS$1.header }) : null;
  }
  renderContent() {
    const content = !!this.contentBehind
      ...
      : [
        h("div", { class: CSS$1.content }, h("slot", null), h("slot", { name: "center-row" }))
      ];
    return content;
  }
  renderFooter() {
    const hasFooter = !!getSlotted(this.el, SLOTS$1.footer);
    return hasFooter ? (h("div", { class: CSS$1.footer }, h("slot", { name: SLOTS$1.footer }))) : null;
  }
  renderMain() {
    const primaryPanel = getSlotted(this.el, SLOTS$1.primaryPanel);
    const mainClasses = {
      [CSS$1.main]: true,
      [CSS$1.mainReversed]: (primaryPanel === null || primaryPanel === void 0 ? void 0 : primaryPanel.position) === "end"
    };
    return (h("div", { class: mainClasses }, h("slot", { name: SLOTS$1.primaryPanel }), this.renderContent(), h("slot", { name: SLOTS$1.contextualPanel })));
  }
  render() {
